...
bmks_d = dm.format_data(bmks,'1D')
bmks_w = dm.format_data(bmks,'1W')
bmks_m = dm.format_data(bmks,'1M')
...
bmks_dict=dm.get_data_dict(bmks, "index")

puts_d = dm.format_data(puts, '1D')
puts_w = dm.format_data(puts, '1W')
puts_m = dm.format_data(puts, '1M')
...
puts_dict=dm.get_data_dict(puts,"index")
...
intl_hedge_d = dm.format_data(intl_hedge, '1D')
intl_hedge_w = dm.format_data(intl_hedge, '1W')
intl_hedge_m = dm.format_data(intl_hedge, '1M')
...
intl_hedge_dict_2= dm.merge_dicts(bmks_dict, puts_dict)
