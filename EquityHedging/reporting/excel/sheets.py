...
def set_analysis_sheet(writer, data_dict, sheet_name, spaces=3):
    ...
    for n in range(0, len(df_list)):
        ...
        # format for return stats
            ...
            # format ret_max1q_dd, skew and avg_pos_ret/avg_neg_ret to digits
            ...
            # format var, cvar to percent
            worksheet.conditional_format(row + 16, col + 1, row + 17, col_dim, {'type': 'no_blanks',
                                                                                'format': pct_fmt})
