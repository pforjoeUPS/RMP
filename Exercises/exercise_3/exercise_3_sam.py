# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 14:48:04 2022

@author: LGQ0NLN
"""
# [13,1,1.25,1,1,1,0.25,1]
#import libraries
...
new_strat = True
if new_strat:
    strategy_list = ['Defensive_Skew']
    filename = 'Defensive_Skew.xlsx'
    sheet_name = 'Sheet1'
...
#run report
equity_hedge_report = 'equity_hedge_ysis_cs_def_skew'
selloffs = True
# start = time.time()
